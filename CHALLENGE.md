This is the coding challenge for people who applied to a frontend developer position. It's been designed to be a simplified version of the same problems we deal with.
